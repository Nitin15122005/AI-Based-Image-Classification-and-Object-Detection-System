...
const SPECS = ['React + Vite Client', 'FastAPI Backend', 'YOLO11s Detection', 'ResNet50 Classification'];
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
        <div className="lg:col-span-8 space-y-4">
          ...
          <p className="font-body-md text-body-md text-on-primary-container max-w-2xl leading-relaxed">
            VisionAI runs a complete computer-vision stack — from image upload through detection
            and classification to a reviewable, responsive result — so you can see exactly what's
            in your images and how confident the model is.
          </p>
